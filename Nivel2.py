...
def main(page: ft.Page):
    ...
    print("Ruta audio segundo nivel:", os.path.join(audio_base_path, "Segundo_Nivel.mp3"))
    print("Ruta imagen segundo nivel:", os.path.join(image_base_path, "Segundo-Nivel.jpeg"))
    ...
    # Se agrega el audio del segundo nivel
    SegundoNivel = ft.Audio(
        src=os.path.join(audio_base_path, "Segundo_Nivel.mp3"), autoplay=False, volume=1, balance=0
    )
    page.overlay.append(SegundoNivel)
    
    page.title = "El Mictlan-Nivel 2"
    page.bgcolor = "#000000"
    page.fgcolor = "#FFFFFF"
    ...
    img = ft.Image(
        src=os.path.join(image_base_path, "Segundo-Nivel.jpeg"),
        width=image_width, height=image_height, fit="contain"
    )
    
    btnPlay = ft.ElevatedButton("Da Click", on_click=lambda _: SegundoNivel.play())
